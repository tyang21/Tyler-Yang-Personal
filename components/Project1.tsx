...
export const Project1 = () => {
  return (
    <section className="section-shell pt-32 pb-14 md:pt-40 md:pb-24"><article className="frost-card rounded-3xl p-5 shadow-sm md:p-8">
      <h1 className="headline mb-4">Project 1: Images of the Russian Empire - Colorizing the Prokudin-Gorskii photo collection</h1>
      <h2 className="text-xl font-semibold mb-6">Tyler Yang</h2>
      <h2 className="text-2xl font-semibold mt-8 mb-3"> Overview</h2>
      <p className='py-3 text-justify leading-relaxed text-[var(--text-soft)]'>
      ...
      />
      <p className='italic py-4 text-[var(--text-soft)]'>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-3"> Solution</h2>
      <p className='text-justify leading-relaxed text-[var(--text-soft)]'>
      ...
      <p className='pl-4 text-justify leading-relaxed text-[var(--text-soft)]'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Cathedral: B Offset: (-7, -1), G Offset: (-12, -3)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Church: B Offset: (-33, 8), G Offset: (-58, 4) </p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Emir: B Offset: (-57, -17), G Offset: (40, -13)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Harvesters: B Offset: (-64, 3), G Offset: (-124, -14)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Icon: B Offset: (-49, -5), G Offset: (-90, -23)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Lady: B Offset: (-60, -4), G Offset: (-112, -12)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Melons: B Offset: (-96, -3), G Offset: (-180, -13)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Monastery: B Offset: (-6, -1), G Offset: (-3, -2)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Onion Church: B Offset: (-57, -10), G Offset: (-108, -36)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Sculpture: B Offset: (-107, 16), G Offset: (-140, 27)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Self Portrait: B Offset: (-98, -8), G Offset: (-176, -37)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Three Generations: B Offset: (-59, 3), G Offset: (-111, -12)</p>
            </div>
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Tobolsk: B Offset: (-4, -1), G Offset: (-7, -3)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Train: B Offset: (-43, -26), G Offset: (-87, -32)</p>
            </div>
        </div>
        <h2 className="text-2xl font-semibold mt-8 mb-3"> Bells and Whistles</h2>
        <p className='text-justify leading-relaxed text-[var(--text-soft)]'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Before Emir: B Offset: (-57, -17), G Offset: (40, -13)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">After Emir: B Offset: (-58, -17), G Offset: (-124, -42) </p>
            </div>
        </div>
        <p className='text-justify leading-relaxed text-[var(--text-soft)]'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Emir: B Offset: (-58, -17), G Offset: (-124, -42)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Harvesters: B Offset: (-64, 3), G Offset: (-123, -13)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Lady: B Offset: (-63, -4), G Offset: (-119, -13)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Melons: B Offset: (-96, -3), G Offset: (-181, -12)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Onion Church: B Offset: (-57, -10), G Offset: (-108, -37)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
            ...
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Self Portrait: B Offset: (-98, -8), G Offset: (-176, -36)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Three Generations: B Offset: (-59, 4), G Offset: (-111, -10)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Tobolsk: B Offset: (-4, 0), G Offset: (-7, -3)</p>
            </div>
            <div className="frost-card rounded-2xl p-3 shadow-sm">
                ...
                <p className="text-center mt-4 text-[var(--text-soft)]">Train: B Offset: (-43, -26), G Offset: (-86, -33)</p>
            </div>
        </div>
    </article>
    </section>
