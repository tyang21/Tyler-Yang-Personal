...
export const Project2 = () => {
    return(
        <section className="section-shell pt-32 pb-14 md:pt-40 md:pb-24"><article className="frost-card rounded-3xl p-5 shadow-sm md:p-8">
            <h1 className="headline mb-4">Project 2: Fun with Filters and Frequencies</h1>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-3"> Part 1: Fun with Filters </h2>
            <p className = 'py-3 text-justify leading-relaxed text-[var(--text-soft)]'>
            ...
            <p className = 'py-3 italic text-justify leading-relaxed text-[var(--text-soft)]'>
            ...
            <p className = 'py-3 text-justify italic leading-relaxed text-[var(--text-soft)]'>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-3"> Part 2: Fun with Frequencies </h2>
            <h3 className='text-xl font-semibold mt-6 mb-2'>
                Sharpening
            </h3>
            <p className = 'py-3 text-justify leading-relaxed text-[var(--text-soft)]'>
